...
public class Phonebook
{
    ...
    {
        if (subscriber == null || number == null)
            throw new ArgumentException("Subscriber or number can't be null.");
        subscriber.PhoneNumbers.Add(number);
    }
    ...
    {
        if (subscriber == null || newName == null)
            throw new ArgumentException("Subscriber or name can't be null.");
    ...
    public void UpdateSubscriber(Subscriber oldSubscriber, Subscriber newSubscriber)
    {
        if (oldSubscriber == null || newSubscriber == null)
            throw new ArgumentException("Subscriber can't be null.");
